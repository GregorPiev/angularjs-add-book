...
angular.module('editSubgenre')
    .controller('editSubgenreController', function ($scope, $routeParams, $location, AddSubgenre, DeleteSubGenre) {
        ...
        $scope.deleteSubgenre = function () {
            DeleteSubGenre.delete({ id: $scope.idGenre, idSubGenre: $scope.index }).$promise
                .then(function (result) {
                    console.log('Result:', result)
                    $location.path(`/success`);
                });
